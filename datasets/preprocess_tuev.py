...
https://github.com/ycq091044/BIOT/blob/main/datasets/TUEV/process.py
"""
...
root = "raw/TUEV/edf"
train_out_dir = os.path.join("processed/TUEV/edf", "train")
eval_out_dir = os.path.join("processed/TUEV/edf", "eval")
