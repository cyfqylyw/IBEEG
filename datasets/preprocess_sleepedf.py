"""
Reference: 
https://github.com/gist-ailab/SleePyCo/blob/main/dset/Sleep-EDF-2018/prepare_sleep-edf-2018.py
"""
...
def main():
    ...
    parser.add_argument("--data_dir", type=str, default="./raw/SleepEDF/sleep-edf-database-expanded-1.0.0/sleep-cassette",
                        help="File path to the Sleep-EDF dataset.")
    parser.add_argument("--output_dir", type=str, default="./processed/sleepedf",
                        help="Directory where to save outputs.")
    parser.add_argument("--select_ch", type=str, default="EEG Fpz-Cz",  # EEG Fpz-Cz, EEG Pz-Oz
