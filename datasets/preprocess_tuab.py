...
if __name__ == "__main__":
    ...
    if not os.path.exists("datasets/processed/TUAB/"):
        os.makedirs("datasets/processed/TUAB/")

    if not os.path.exists(os.path.join("datasets/processed/TUAB/", "train")):
        os.makedirs(os.path.join("datasets/processed/TUAB/", "train"))
    train_dump_folder = os.path.join("datasets/processed/TUAB/", "train")

    if not os.path.exists(os.path.join("datasets/processed/TUAB/", "val")):
        os.makedirs(os.path.join("datasets/processed/TUAB/", "val"))
    val_dump_folder = os.path.join("datasets/processed/TUAB/", "val")

    if not os.path.exists(os.path.join("datasets/processed/TUAB/", "test")):
        os.makedirs(os.path.join("datasets/processed/TUAB/", "test"))
    test_dump_folder = os.path.join("datasets/processed/TUAB/", "test")
